...
@section('noidung')
 ...
 <div class="container-fluid" style="background:linear-gradient( rgb(18, 107, 110),#3dafb3 100%);">
        <div class="col-md-10">
            <h5 style="padding: 5px;"><span style="color: white;margin-left: 3px;">DANH MỤC QUẢN LÝ » </span> <i style="color: #fed000;">Giống cây</i></h5>
        </div>
        <div class="col-md-1" >
        ...
        <div class="col-md-1">
            <!--them moi giong cay-->
            <a href="/them-giongcay" class="btn fa fa-plus" style="background-color: #EF5350;color: white;margin-top:8%;padding:10%;">Thêm mới</a>
