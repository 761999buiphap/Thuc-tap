...
<div class="container-fluid" style="background:linear-gradient( rgb(14, 84, 87) ,rgb(18, 107, 110) 100%);">
    ...
    <div class="container-fluid">
        <div class="row " style="background-color:rgb(18, 107, 110);">
            ...
            <div class="col">
                <div class="dropdown">
                    <a  href="/choxuli" style="background-color:rgb(14, 84, 87);color: white;font-weight: bold;padding: 7% 17%;" class="btn btn-default " type="button" ><img src="https://img.icons8.com/office/25/000000/List-of-parts.png"/><br>ĐƠN HÀNG</a>
                </div>
            </div>
            <div class="col">
                <a href="danhsach-binhluan" style="background-color:rgb(14, 84, 87);color: white;font-weight: bold;padding: 7% 17%;" class="btn btn-default " type="button"><img src="https://img.icons8.com/fluency/25/000000/edit-chat-history.png"/><br>BÌNH LUẬN</a>
            </div>
            <div class="col">
                <div class="dropdown">
            ...
            <div class="col">
                <a href="danhsach-khachhang" style="background-color:rgb(14, 84, 87);color: white;font-weight: bold;padding: 6% 12%;" class="btn btn-default " type="button" ><img src="https://img.icons8.com/color/25/000000/attract-customers.png"/><br>KHÁCH HÀNG</a>
            </div>
            <div class="col">
                <a href="danhsach-lienhe" style="background-color:rgb(14, 84, 87);color: white;font-weight: bold;padding: 7% 30%;" class="btn btn-default " type="button" ><img src="https://img.icons8.com/fluency/25/000000/new-contact.png"/><br>LIÊN HỆ</a>
            </div>
            <div class="col">
                <a href="danhsach-nhanvien" style="background-color:rgb(14, 84, 87);color: white;font-weight: bold;padding: 7% 18%;" class="btn btn-default " type="button" ><img src="https://img.icons8.com/fluency/25/000000/staff.png"/><br>NHÂN VIÊN</a>
            </div>
            <div class="col">
                <a href="danhsach-user/0" style="background-color:rgb(14, 84, 87);color: white;font-weight: bold;padding: 7% 17%;" class="btn btn-default "  ><img src="https://img.icons8.com/color/25/000000/blocked-account-male.png"/><br>TÀI KHOẢN</a>
            </div>
            <div class="col">
                <a href="danhsach-baocao" style="background-color:rgb(14, 84, 87);color: white;font-weight: bold;padding: 7% 19%;" class="btn btn-default " type="button"><img src="https://img.icons8.com/office/25/000000/play-graph-report.png"/><br>THỐNG KÊ</a>
            </div>
            <div class="col">
