...
<div class="container-fluid" style="height:85px;padding-left: 7%;">
        <h3 style="font-weight: bold;color: black;">Sản phẩm mới nhất</h3>
        <p><a style="text-decoration:none;color: rgb(18, 107, 110);" href="">Trang chủ</a>  <span style="color: #ccc;"> / </span>  <span style="font-weight: bold;color:rgb(18, 107, 110);">Sản phẩm mới nhất</span></p>
    </div>
<div id="sanpham" class="container-fluid" style="background-color: #f4f4f4;">
    ...
    <div id="sp_hover" class=" col-md-2 thumbnail" style="text-align:center; box-shadow: 0 0px 8px 0 rgba(0, 0, 0, 0.2);margin: 10px;">
        ...
        <span style="overflow:hidden;width:100%;">{{$value->ten}}</span><br>
