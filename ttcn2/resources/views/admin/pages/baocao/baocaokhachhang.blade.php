...
.amcharts-export-menu-top-right {
  ...
  <div class="div2" style="margin-top:1%;padding:3px 0;">
    ...
    <h4 style="color:green;"><img src="https://img.icons8.com/dusk/30/000000/bookmark.png"/> BÁO CÁO KHÁCH HÀNG</h4>
    <form action="ketqua-baocao-khachhang" method="post" class="form-group">
    <input type="hidden" name="_token" value="{{csrf_token()}}" />
    <div class="row">
    <div class="col-md-4">
...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link active" data-toggle="tab" href="#home">Danh sách khách hàng</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="#menu2">Biểu đồ thống kê theo số lượng khách hàng</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="#menu1">Biểu đồ thống kê theo giới tính</a>
  </li>
...
<div class="tab-pane container active" id="home">
    <table class="table table-hover" style="width: 87%;">
                <thead>
                <tr><th></th><th>#</th><th>Tên khách hàng</th><th>Giới tính</th><th>Email</th><th>Số điện thoại</th><th>Địa chỉ</th><th>Ngày</th></tr>
                </thead>
                <tbody>
                  <tr>
                    <?php $i=1;
