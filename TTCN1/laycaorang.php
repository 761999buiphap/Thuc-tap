...
<body style='font-family:arial;'>
    ...
    <div class="div2">
        ...
        <div class=div2form>
        <?php 
            $truyvansum="SELECT COUNT(mabs) AS dem FROM laycaorang WHERE mabs='$tentk'";
    ...
    <div class=div3>
        ...
        //Lưu
            if(isset($_POST['luu']))
            {
                ...
                {
                    $truyvanluu="INSERT INTO laycaorang(mabn,mabs,ngay,dungcu,denghi,ghichu) VALUES('$mabn','$tentk','$ngay','$dungcu','$denghi','$ghichu')";
        ...
        <div class="div3_1">
            <?php 
                if(isset($_POST['mabn'])||isset($_POST['kham']))
                {
                    ...
                    echo "<br><span>Bác sĩ thực hiện: </span>"  ."<span style='color:green;'>".$row2['hoten'] ."</span>" ."<span style='margin-left:40px;font-weight:blod;'>Chỉ định: </span><span style='color:green;'> Lấy cao răng</span>";
        ...
        <div class='div3_2'>
            ...
            <?php
                $ngay=date('Y-m-d');
                $truyvan="SELECT * FROM thuthuat WHERE thuthuatdieutri='Lấy cao răng' and ngaythuchien='$ngay'";
                $lienket=mysqli_query($CONN,$truyvan);
                if(mysqli_num_rows($lienket)>0)
                {
                        while($row=mysqli_fetch_assoc($lienket))
                        {
                            $truyvan1="SELECT * FROM laycaorang WHERE ngay='$ngay' and mabn='$row[mabn]'";
                            $lienket1=mysqli_query($CONN,$truyvan1);
        ...
        <h4 style='margin-top:30px;color:white;text-align:center;'>Danh sách lịch hẹn</h4>
            ...
            <?php
                $truyvan2="SELECT * FROM lichhen WHERE noidung='Lấy cao răng' and ngayhen='$ngay'";
                $lienket2=mysqli_query($CONN,$truyvan2);
