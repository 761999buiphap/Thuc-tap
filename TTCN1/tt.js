...
document.getElementById("thuthuat").addEventListener("click", tt);
...
function lh() {
    ...
    "<p style='width: 86%;height: 350px;margin-top: 7%;margin-left: 7%; font-family: arial;'>Nguyên nhân dẫn đến tình trạng nhầm lẫn, quên lịch hẹn với khách hàng  là do quản lý thủ công, dữ liệu không đồng nhất (bằng word, excel, giấy nhớ). Mỗi nhân viên lưu một cách, nên không thể tránh được nếu sai sót lịch hẹn, làm giảm uy tín và độ chuyên nghiệp của phòng khám, khách hàng không hài lòng. <br>Tối ưu hóa quy trình xếp lịch hẹn sẽ giúp tăng lợi nhuận, tăng năng suất làm việc và thể hiện sự chuyên nghiệp với khách hàng <br>Quản lý lịch hẹn tại <span style='color:red'>Phần mềm quản lý Nha khoa BambuFit</span> sẽ giúp Phòng khám: <br>- Ghi lại lịch hẹn của khách hàng trên một hệ thống duy nhất <br>- <span style='color:red'>Tạo lịch hẹn đơn giản</span>, dễ dàng, nhanh chóng. <br>- <span style='color:red'>Thông tin lưu trữ lịch hẹn đầy đủ:</span> Ngày, tháng, năm, giờ, họ tên, số điện thoại, nội dung hẹn, Bác sĩ hẹ<n class='br'></n>- <span style='color:red'>Hiển thị trạng thái lịch hẹn trực quan,</span> sinh động với đầy đủ các thông tin được lưu trữ <br>- <span style='color:red'>Tìm kiếm lịch hẹn theo nhiều tiêu chí:</span> Tìm kiếm theo từ khóa, bác sĩ thực hiện, tìm trạng hẹn. <br>"+
