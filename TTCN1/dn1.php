            ...
            if(!empty($_POST['tentk']) && !empty($_POST['matkhau']))
                {
                    ...
                    if($row>0)
                    {
                        ...
                        if(mysqli_num_rows($ketnoi1)==1)
                        {
                            ...
                            echo "<a id='diva' href='GDQL_BN.php?tentk=".$tentk."'>Bắt đầu quản lý</a>";
                            include("footer.php");
                            exit;
                        }
                        else
                    ...
                    if($row2>0)
                    {
                        ...
                        {
                            echo "<h1>Đăng nhập thành công !</h1>";
                            echo "<a id='diva' href='GDQL_BS.php?tentk=".$tentk."'>Bắt đầu quản lý</a>";
                            include("footer.php");
                            exit;
                        }
                        else
                    ...
                    if($row3>0)
                    {
                        ...
                        if(mysqli_num_rows($ketnoi33)==1)
                        {
                            ...
                            echo "<a id='diva' href='GDQL_AD.php?tentk=".$tentk."'>Bắt đầu quản lý</a>";
                            include("footer.php");
                            exit;
                        }
                        else
                    ...
                    if($row4>0)
                    {
                        ...
                        {
                            echo "<h1>Đăng nhập thành công !</h1>";
                            echo "<a id='diva' href='GDQL_NV.php?tentk=".$tentk."'>Bắt đầu quản lý</a>";
                            include("footer.php");
                            exit;
                        }
                        else
