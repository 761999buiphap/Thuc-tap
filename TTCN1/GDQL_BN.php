...
<body>
    ...
    <div class="div2" style="margin:8% 2% 0px 115px;">
        ...
        <div style="margin-left:10%;height:85px;">
            ...
            <?php echo "<a class='div2_a' href='HSBN_benhnhan.php?tentk=".$tentk."'><h2>Lịch sử khám</h2></a>";?>
        </div>
        <div style="margin-left:10%;height:85px;">
            <img src="hinhanh/nhanxet1.jpg" alt="" style="width:17%;border-radius:50%;float:left; margin-right:5%;">
            <?php echo "<a class='div2_a' href='phieunhanxet.php?tentk=".$tentk."'><h2>Phiếu lấy ý kiến</h2></a>";?>
        </div>
        <div>
    </div>
    </div>
