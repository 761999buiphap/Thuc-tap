...
<head>
    ...
    <title>Phần mềm quản lý phòng khám nha khoa</title>
...
<body>
    <div class="header"></div>       
        ...
        <div class="thanhmenu">
            <ul class="thanhdieuhuong">
                ...
                <li id="trangchu" class="li"><a class="menu" href="trangchu.php" style=" color:rgb(24, 162, 180)" ><u> TRANG CHỦ</u></a></li>
            </ul>
        </div>
    </div>
    <div class="w3-content w3-display-container" style="position: relative;">
        <img class="mySlides" src="hinhanh/anhnen.jpg" style="width:100%">
      </div>
    <div class="div3" >
    ...
    <div class="div5" >
        ...
        <h2 style="text-align: center;"><a class="div5dichvu" href="dichvu.php"> DỊCH VỤ</a></h2>
