...
<body style="font-family:arial;">
    ...
    <div class=div4>
        <form method=POST>
            <input style="margin:1% 0px 0px 5%;" type="submit" name='hoadon' value='Hóa đơn'>
             ...
             $truyvan1="SELECT * FROM thuoc WHERE nhomthuoc='Kháng sinh'";
                 ...
                 while($row1=mysqli_fetch_assoc($lienket1))
                 {
                    ...
                    echo "<td ><input type=checkbox name=mathuoc value='$row1[mathuoc]'></td>";
                     ...
                     echo "<td style='width:82px;'><input type=submit name=suathuoc value=Sửa><input type=submit name=xoathuoc value=Xóa></td></tr></from>";
