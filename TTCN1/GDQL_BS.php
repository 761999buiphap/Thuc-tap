...
<body>
    ...
    <div class="div2" style="margin:8% 2% 0px 115px;">
        ...
        <div style="margin-left:10%;height:85px;">
            <img src="hinhanh/timhieuthem5.JPG" alt="" style="width:17%;border-radius: 50%;float:left; margin-right:5%;">
            <?php echo "<a class='div2_a' href='lichhen.php?tentk=".$tentk."'><h2>Lịch hẹn</h2></a>";?>
        </div>
        <div style="margin-left:10%;height:85px;">
            <img src="hinhanh/hosobn.png" alt="" style="width:17%;border-radius: 50%;float:left; margin-right:5%;">
            <?php echo "<a class='div2_a' href='HSBN_bacsy.php?tentk=".$tentk."'><h2>Hồ sơ bệnh nhân</h2></a>";?>
        </div>
        <div>
    </div>
    </div>
