...
<body>
    <?php 
        ...
        if(isset($_POST['gui']))
        {
            ...
            $thang=date('Y-m-d');
            if(!empty($hoten) && !empty($sdt) && !empty($diachi) && !empty($noidung) && !empty($email))
            {
                $truyvan="INSERT INTO lienhe(hoten,sdt,email,diachi,noidung) VALUES('$hoten','$sdt','$email','$diachi','$noidung')";
                $lienket=mysqli_query($CONN,$truyvan);
                $err="<h3 style=' margin-left:5%;color:red;'> Gửi thành công !</h3>";
            }
            else
                $err="<h3 style=' margin-left:5%;color:red;'> Nhập vào đầy đủ thông tin !</h3>";
        }
    ...
    <div id="header" class="header"></div>       
        ...
        <div class="thanhmenu">
            <ul class="thanhdieuhuong"">
                ...
                <li class="li"><a class="menu" href="lienhe.php" style=" color:rgb(24, 162, 180)"><u>LIÊN HỆ</u></a></li>
    ...
    <div class="div1">
        <h2 style="color:white;position: absolute;left: 46%; top: 10%;font-family: arial;">LIÊN HỆ</h2>
        <ul class="div1_ul">
            ...
            <li style="float: left ;font-weight:bolder;font-family: arial;"><a style="color: white;text-decoration: none;" href="gioithieu.php">Liên hệ</a></li>
        </ul>
    </div>
    
    <div class="div2">
        <div class="div2_trai" >
            <h2 style="color: rgb(24, 162, 180);">LIÊN HỆ VỚI CHÚNG TÔI</h2>
            <h3>CÔNG TY TNHH BAMBU VIỆT NAM</h3>
            <p>Địa chỉ: Số 194 tổ 18, ngõ 624/16, đường Minh Khai, Phường Vĩnh Tuy, Quận Hai Bà Trưng, Tp.Hà nội</p>
            <p>VPĐD: Số 10 tầng 2, TTTM V+, tòa nhà Hòa Bình Green City, 505 Phố Minh Khai, Quận Hai Bà Trưng, Hà Nội</p>
            <p>Điện thoại: 024.22151674 - Hotline 24/7 : 0942.116.117</p>
            <p>Email: info@bambu.vn</p>
            <p>Giấy phép ĐKKD: Số 0104002632 cấp ngày 30/01/2008 bởi Sở Kế Hoạch và Đầu Tư TP. Hà Nội</p>
        </div>
        <div class="div2_phai">
            <h3>VUI LÒNG NHẬP THÔNG TIN LIÊN HỆ</h3>
            <form method="POST">
                <?php echo $err; ?><br>
                <input type="text" id="hoten" name="hoten" placeholder="Họ và tên *">
                <input type="text" id="sdt" name="sdt" placeholder="Điện thoại *"><br>
                <input type="text" id="email" name="email" placeholder="Email *">
                <input type="text" id="diachi" name="diachi" placeholder="Địa chỉ *"><br>
                <textarea  name="noidung" id="noidung" cols="75" rows="7" placeholder="Nội dung"></textarea> <br>
                <input style="background-color: rgb(173, 75, 75);" type="submit" name="gui" value="Gửi liên hệ">
            </form>
