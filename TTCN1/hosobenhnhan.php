...
<body>
    ...
    <div class="div2">
        <form class="div2form" method="POST">
            ...
            <?php echo "<a style='background-color:rgb(37, 158, 37);padding:5px;color:white;text-decoration:none;border:2px solid black;font-size:13px;' href='themhsbn.php?tentk=".$tentk.">Thêm mới</a>";?>
            <input style="background-color:rgb(37, 158, 37);color:white;" type="submit" name="thoat" value="Thoát">
