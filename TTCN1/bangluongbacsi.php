...
<div class="div2">
        ...
        <p>BẢNG LƯƠNG >> <span style="color:blue;">Bác sĩ</span> </p>
</div>
<?php
//===Khi them moi===
if(isset($_POST['them'])||isset($_GET['luong']))
{
    ...
    $nam=Date("Y");
                                ...
                                echo "</tr>";
                                $i=0;
                                    $truyvanbs="SELECT * FROM hosobacsy ";
                                    $lienketbs=mysqli_query($CONN,$truyvanbs);
                                    if(mysqli_num_rows($lienketbs)>0)
                                    {
                                        while($rowbs=mysqli_fetch_assoc($lienketbs))
                                        {
                                            $truyvanbs1="SELECT * FROM luong WHERE mabs='$rowbs[mabs]' AND nam=$nam AND thang=$thang";
                                            ...
                                            echo "<form method='POST' action='sua.php?tentk=$tentk&&bacsi=$rowbs[mabs]'>";
                                            echo "<tr>";
                                            echo "<td>$i</td>";
                                            echo "<td >" .$rowbs['mabs'] ."</td>";
                                            ...
                                            echo "<td>" ."<input style=' background-color:rgb(37, 158, 37);padding:2px 3px ;color:white;border:2px solid black;font-size:13px;' type=submit name='luongbs' value=Thêm><input style=' background-color:rgb(37, 158, 37);padding:2px 3px ;color:white;border:2px solid black;font-size:13px;' type=submit name='sualuongbs' value=Sửa><input style=' background-color:rgb(37, 158, 37);padding:2px 3px ;color:white;border:2px solid black;font-size:13px;' type=submit name='xoaluongbs' value=Xóa>" ."</td>" ;                                                               
                                            echo "</tr>";
                                            echo "</form>";
                                            echo "</div>";
...
<?php
    ...
    if(isset($_POST['loctim']) || isset($_GET['bangluong']))
    {
        ...
        {   
            $truyvan1="SELECT * FROM luong WHERE thang='$thang' and nam='$nam'";
            ...
            if(mysqli_num_rows($lienket1)>0)
                        {   
                            ...
                            while($row=mysqli_fetch_assoc($lienket1))
                            {
                                ...
                                echo "<form method='POST' action='sua.php?tentk=".$tentk."&&thang=$thang&&nam=$nam&&mabs=$row[mabs] '>";
                                echo "<tr>";
                                echo "<td>$i</td>";
                                echo "<td >" .$row['mabs'] ."</td>";
                                echo "<td >" .$rowbs['hoten'] ."</td>";
