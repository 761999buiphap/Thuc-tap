...
?>
    ...
    if(isset($_POST['loctim']) || isset($_GET['quaylai']))
    {
        if(!empty($_POST['mabn']) || isset($_GET['quaylai']))
        {   
                ...
                if(mysqli_num_rows($lienket1)>0)
                {
                    while($row1=mysqli_fetch_assoc($lienket1))
                    {
                        ...
                        echo "<input style='margin-left:86px;width:25%;' type='text' name='email' value='$row1[email]'><br>";
                        ...
                        echo "<input style='margin-left:41px;' type='text' name='sdt'value='$row1[sdt]'><br><br>";
                        echo "<td><a style='width:10%;font-size:15px; background-color:rgb(37, 158, 37);color:white;padding:5px;text-decoration:none;border:2px solid black;position:absolute;top:18%;right:6%;text-align:center;' href='dangkikham.php?mabn=$mabn&tentk=".$tentk."'>Ghi kết quả</a></td>";
                        echo "</form>";
                        echo "</div>";
                        echo "<br><br><br><h3 style='margin-left:8%;'>~~~ Bệnh án ~~~</h3><br>";
                    ...
                    $truyvan2_dt="SELECT MAX(lankham) FROM donthuoc WHERE mabn='$mabn'";
                    ...
                    for($i=1;$i<=$n;$i++)
                        ...
                        {
                             echo "<h3 style='color:red;text-align:center;'>< Không tìm thấy bệnh nhân này ></h3>";              
...
<div class="div8">
<form method="POST">
            <input style="width:130px;" type="text" name="mabn" placeholder="Nhập mã bệnh nhân"><br><br><br>
